...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_dimension":["list",["map","index","1","dimension",["macro",9]],["map","index","2","dimension",["macro",10]],["map","index","3","dimension",["macro",11]],["map","index","4","dimension",["macro",12]],["map","index","5","dimension",["macro",13]],["map","index","6","dimension",["macro",14]]],
      ...
      "vtp_setTrackerName":false,
      "vtp_useDebugVersion":false,
      "vtp_fieldsToSet":["list",["map","fieldName","allowLinker","value","false"],["map","fieldName","page","value",["macro",16]],["map","fieldName","title","value",["macro",17]],["map","fieldName","userId","value",["macro",8]]],
      "vtp_useHashAutoLink":false,
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":false,
  ...
  "rules":[
    [["if",0,1],["add",0,1,8,11,12,13,16,17,19]],
    [["if",3],["add",2],["block",3]],
    [["if",4],["add",3],["block",2]],
    [["if",1,5],["add",4]],
    [["if",6,7],["add",5]],
    ...
    [["if",1,13],["add",14]],
    [["if",1,14],["add",20]],
    [["if",1,2],["block",0,1,4,5,6,7,8,16,17,18,19]]]
},
"runtime":[
[],[]
]};
...
var gc={},hc=null;gc.m="GTM-P5GCKB";var ic=null,jc="//www.googletagmanager.com/a?id="+gc.m+"&cv=41",kc={},lc={};var mc=function(){},nc=function(a){return"function"==typeof a},oc=function(a){return"string"==ta(a)},pc=function(a){return"number"==ta(a)&&!isNaN(a)},qc=function(a){return Math.round(Number(a))||0},rc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},sc=function(a){var b=[];if(oa(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},tc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},uc=function(a,b){if(!pc(a)||!pc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
